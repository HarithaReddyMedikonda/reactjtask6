  ...
  return (
    <div className="portfolio">
      <div className="header">
        <h1>Haritha reddy Medikonda</h1>
        <h2>Student</h2>
        <div className="contact-info">
          <h3>
            <a href="mailto:haritha.21bce7290@vitapstudent.ac.in">haritha.21bce7290@vitapstudent.ac.in</a>
          </h3>
          <h3>Phone Number:7671908014</h3>
        </div>
      </div>
      ...
      <div className="contact">
        ...
        <p>Email: 
            <a href="mailto:harithareddyy97@gmail.com">harithareddyy97@gmail.com</a></p><p>Phone:7671908014
            </p></div></div>);
};
